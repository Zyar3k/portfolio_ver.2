...
const About = () => {
  return (
    <div className='viewContent aboutContent'>
      <section>
        <p>
          <img src={imgLearn} alt='learning' /> Nazywam się arkadiusz zygan. W
          2019 roku postanowiłem usystematyzować wiedzę z zakresu kodowania i
          programowania. Na przestrzeni lat interesowałem się nowymi
          technologiami, jednak nie uzyskałem pełnej wiedzy teoretycznej, jak i
          nie zrealizowałem praktycznych projektów. Od tamtego czasu
